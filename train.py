...
def train(data_directory, arch, num_classes, hidden_units, learning_rate, epochs, gpu, save_dir):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--arch', action='store', dest='arch', required=False, default="densenet")
    ...
    train(_args.data_directory, _args.arch, int(_args.num_classes), int(_args.hidden_units), float(_args.learning_rate), int(_args.epochs), _args.gpu, _args.save_dir)
